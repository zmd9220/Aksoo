<template>
  <div class="ranking-list-item-wrapper">
    <div class="ranking-list-item">
      <div class="rank" style="width: 3%">{{ item.rank }}.</div>
      ...
      >
        <img
          v-if="item.tier == 5"
          src="@/assets/Ranking/brz.png"
          alt="tier_picture"
          style="height: 40%; margin-right: 1vw"
        />
        <img
          v-if="item.tier == 4"
          src="@/assets/Ranking/slv.png"
          alt="tier_picture"
          style="height: 40%; margin-right: 1vw"
        />
        <img
          v-if="item.tier == 3"
          src="@/assets/Ranking/gld.png"
          alt="tier_picture"
          style="height: 40%; margin-right: 1vw"
        />
        <img
          v-if="item.tier == 2"
          src="@/assets/Ranking/pltn.png"
          alt="tier_picture"
          style="height: 40%; margin-right: 1vw"
        />
        <img
          v-if="item.tier == 1"
          src="@/assets/Ranking/dmd.png"
          alt="tier_picture"
          style="height: 40%; margin-right: 1vw"
        />
